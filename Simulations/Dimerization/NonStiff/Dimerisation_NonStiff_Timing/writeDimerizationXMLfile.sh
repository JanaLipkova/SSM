...
MethodsList="SLeaping TauLeaping RLeapingJana AdaptiveTau AdaptiveS SSA"
 ...
 version="2">
    ...
    <model name="Dimerization_${method}">
                ...
                <annotation xmlns:stochSim="AnnotationField">
                        ...
                        <stochSim:NumberOfSamples>      100      </stochSim:NumberOfSamples>
