...
# 2) write xml file into the bin folder
./writeDimerizationXmlFile.sh ${eps} ${method} ${binFolder}

# 3) write run.sh file
XMLscriptName=Dimerization-${method}-${eps}.xml
