...
//	void		parseAnnotation();
	double		dFindSubstringAnnotationL1(string annotation, string s [2]);
	string		sFindSubstringAnnotationL1(string annotation, string s [2]);

	double		dFindSubstringAnnotationL2(string annotation, string s);
	string		sFindSubstringAnnotationL2(string annotation, string s);
