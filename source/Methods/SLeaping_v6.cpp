...
#include "SLeaping_v6.h"
#include "../my_rand.h"

SLeaping_v6::SLeaping_v6(Simulation * simulation):
LeapMethod(simulation)
{ }

SLeaping_v6::~SLeaping_v6()
{ }

double SLeaping_v6::computeTimeStep()
{
...
void SLeaping_v6::computePropensities()
{
    int nu;
    ParticleType x;
...
void SLeaping_v6::computePropensitiesGrowingVolume(Array< double , 1 > & propensitiesVector, double time, double genTime)
{
...
void SLeaping_v6::executeSSA(double& t, int SSAsteps)
{
    int count = 0.;
    double a0 = 0.;
    double tau;
...
void SLeaping_v6::executeSSA_lacZlacY(double& t, int SSAsteps, double genTime)
{
    int count = 0.;
    double a0 = 0.;
    double tau;
