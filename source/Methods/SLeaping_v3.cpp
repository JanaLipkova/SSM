...
SLeaping_v3::~SLeaping_v3()
{ }

double SLeaping_v3::computeTimeStep()
{
...
void SLeaping_v3::computePropensities()
{
    int nu;
    ParticleType x;
...
void SLeaping_v3::computePropensitiesGrowingVolume(Array< double , 1 > & propensitiesVector, double time, double genTime)
{
...
void SLeaping_v3::executeSSA(double& t, int SSAsteps)
{
    int count = 0.;
    double a0 = 0.;
    double tau;
...
void SLeaping_v3::executeSSA_lacZlacY(double& t, int SSAsteps, double genTime)
{
    int count = 0.;
    double a0 = 0.;
    double tau;
...
void SLeaping_v3::solve()
{
    cout << "SLeaping_v3..." << endl;
