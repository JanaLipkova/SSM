...
eps_n = zeros(1,length(eps));
 ...
 for k = 1:length(eps)
    ...
    load([ 'SLeaping_v3_1/eps_' eps{k} '_hist.mat']);
    f_sleap_v3_1=frq;
    e_sleap_v3_1=edges;
    ...
    for i = list
        for Sp = SpList
            ...
            err_s_v3_1(k)= err_s_v3_1(k) +  h*sum( abs( f_sleap_v3_1{i,Sp} - f_ssa{i,Sp}) );
...
lh = legend('$\;$ $\tau$-leap','$\;$ ad. $\tau$-leap','$\;$ r-leap', ...
            '$\;$ s-leap v3','$\;$ s-leap v3-1','$\;$ s-leap v4','$\;$ s-leap v5','$\;$ ad. s-leap' );
